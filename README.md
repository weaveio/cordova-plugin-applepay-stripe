...
## Installation
```
$ cordova plugin add --save cordova-plugin-applepay-stripe --variable STRIPE_PUBLISHABLE_KEY="pk_live_xxxxxxxxxxxxxxxxxxxxxxxx" --variable APPLE_MERCHANT_IDENTIFIER="merchant.com.yourstoreid"
```
